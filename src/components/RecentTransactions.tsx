      ...
      <div className="max-h-[220px] overflow-y-auto">
        {items.length === 0 ? (
          ...
          <ul className="divide-y divide-gray-100 dark:divide-gray-800">
            {items.map((tx) => (
              <li key={tx.id} className="px-4 py-3 hover:bg-gray-50/80 dark:hover:bg-gray-800/80 transition-colors">
                <p className="text-sm text-gray-900 dark:text-white font-medium leading-snug pr-1">{tx.description}</p>
                <a
